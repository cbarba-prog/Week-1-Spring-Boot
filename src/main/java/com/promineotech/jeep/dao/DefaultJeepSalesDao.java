...
public class DefaultJeepSalesDao implements JeepSalesDao {
  ...
  public List<Jeep> fetchJeeps(JeepModel model, String trim) {
    log.info("DAO fetchJeeps: model={}, trim={}", model, trim);
 ...
 // @formatter:off
    ...
    paramMap.put("model_id", model.toString());
    paramMap.put("trim_level", trim);
    
    return jdbcTemplate.query(sql, paramMap, new RowMapper<>() {
